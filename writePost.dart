...
class _WritePost extends State<WritePost>{
  ...
  Future<void> _getImageAndCrop() async {
    var imageFileFromGallery = await ImagePicker.pickImage(source: ImageSource.gallery);
    if (imageFileFromGallery != null) {
      var CroppedFile = await Utils.cropImageFile(imageFileFromGallery);
      await CroppedFile;
      if (cropImageFile != null) {
        setState(() {
          _postImageFile = cropImageFile as File;
        });
      }
    }
  }
